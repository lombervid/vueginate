...
describe('useStyles', () => {
  ...
  test.each([
    { custom: {}, expected: DEFAULT_STYLES },
    {
      ...
      expected: { ...DEFAULT_STYLES, container: `${DEFAULT_STYLES.container} custom-container` }
    },
    {
      custom: {
        container: 'custom-container',
  ...
  test.each([
    {
      ...
      expected: { ...DEFAULT_STYLES, item: 'default-item', disabled: 'disabled custom-disabled' }
    },
    {
      custom: { disabled: 'custom-disabled' },
      defaults: false,
  ...
  ])('default and custom styles customization', ({ custom, defaults, expected }) => {
    testStyles.value = custom
    testDefaultStyles.value = defaults
